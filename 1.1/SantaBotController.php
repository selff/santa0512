...
{
    const BOTTOKEN    = '1437468410:AAG5qCp57opoQczctB9UVFgeB8Cyshwa__';
    ...
    {
        $this->redis = Yii::app()->redis->client();
        $this->redis->select(SocialHelper::DB_BUFFER);
    ...
    public function actionIndex()
    {
        ...
        $value = $this->getFromBuffer(implode('_', ['TG', $chatId, $updateData['update_id']]));
        if ($value) {
            return;
        }
        $this->saveToBuffer(implode('_', ['TG', $chatId, $updateData['update_id']]), 1);
